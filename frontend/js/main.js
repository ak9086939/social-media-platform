...
function displayNavbar() {
    ...
    if (
        ...
        navLinks.innerHTML = `<a href="index.html">Home</a>
            <a href="${createProfileLink(currentUserId)}">My Profile</a>
            <a href="notifications.html", id="notification-link">
                🔔 Notifications
                <span
...
function displayUser() {
    ...
    if (currentUser) {
        userSection.innerHTML = `<h2>Welcome,${currentUser.name || "User"}👋</h2>
        ...
        userSection.innerHTML = `<h2>Welcome to SocialApp 🚀</h2>
...
function displayPosts(posts) {
    ...
    posts.forEach(
        function (post) {
            ...
            const authorName = typeof author === "object" ? author.name || "Unknown User" : "Unknown User";
            const authorUsername = typeof author === "object" ? author.username || "unknown" : "unknown";
            const likes = Array.isArray(post.likes) ? post.likes : [];
            const comments = Array.isArray(post.comments) ? post.comments : [];
            const isLiked = likes.some(function (like) {
                        const likeId = getUserId(like);
            ...
            if (authorId) {
                postHTML + = 
                    `<h3 class="post-author">
                        <a href="${createProfileLink(authorId)}">
                            ${authorName}
                        </a>
                    </h3>
                `;
...
function addPostEvents() {
    ...
    document.querySelectorAll(".delete-comment-btn")
        .forEach(
            function (button) {
                button.addEventListener("click",
                    function () {
        ...
        if (
            ...
            data.users.forEach(
                function (user) {
                    ...
                    userDiv.innerHTML = `
                        <a href="${createProfileLink(userId)}">
                            ${
...
window.addEventListener(
    ...
    function () {
        ...
        if (postElement) {
            ...
            postElement.style.border = "3px solid orange";
...
setInterval(getUnreadNotificationCount,10000);
